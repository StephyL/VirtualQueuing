...
} from "./chunk-2L6JJSEY.js";
import {
  require_prop_types
} from "./chunk-IW3CP477.js";
import {
  require_react_dom
...
var Checkbox = function(_Component) {
  ...
  _proto.render = function render() {
    ...
    var classes = clsx_m_default("ui", useKeyOnly(checked, "checked"), useKeyOnly(disabled, "disabled"), useKeyOnly(indeterminate, "indeterminate"), useKeyOnly(isNil_default(label), "fitted"), useKeyOnly(radio, "radio"), useKeyOnly(readOnly, "read-only"), useKeyOnly(slider, "slider"), useKeyOnly(toggle, "toggle"), "checkbox", className);
...
function createHybrid(func, bitmask, thisArg, partials, holders, partialsRight, holdersRight, argPos, ary, arity) {
  ...
  function wrapper() {
    ...
    if (isCurried && length < arity) {
      ...
      return createRecurry_default(func, bitmask, createHybrid, wrapper.placeholder, thisArg, args, newHolders, argPos, ary, arity - length);
    }
